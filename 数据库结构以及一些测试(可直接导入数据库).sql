...
INSERT INTO `myblog`.`menu` (`id`, `menu_name`, `menu_link`, `menu_title`, `style`, `active`, `seq`) VALUES ('9', '首页', '/', '首页', 'am-icon-home', 'Y', '1');
INSERT INTO `myblog`.`menu` (`id`, `menu_name`, `menu_link`, `menu_title`, `style`, `active`, `seq`) VALUES ('10', '分类', '/categories', '分类', 'am-icon-th', 'Y', '2');
INSERT INTO `myblog`.`menu` (`id`, `menu_name`, `menu_link`, `menu_title`, `style`, `active`, `seq`) VALUES ('11', '归档', '/archives', '归档', 'am-icon-archive', 'Y', '3');
INSERT INTO `myblog`.`menu` (`id`, `menu_name`, `menu_link`, `menu_title`, `style`, `active`, `seq`) VALUES ('12', '标签', '/tags', '标签', 'am-icon-tags', 'Y', '4');
INSERT INTO `myblog`.`menu` (`id`, `menu_name`, `menu_link`, `menu_title`, `style`, `active`, `seq`) VALUES ('13', '更新', '/update', '更新', 'am-icon-calendar-plus-o', 'Y', '5');
INSERT INTO `myblog`.`menu` (`id`, `menu_name`, `menu_link`, `menu_title`, `style`, `active`, `seq`) VALUES ('14', '友链', '/friendlylink', '友链', 'am-icon-street-view', 'Y', '6');
INSERT INTO `myblog`.`menu` (`id`, `menu_name`, `menu_link`, `menu_title`, `style`, `active`, `seq`) VALUES ('15', '关于我', '/aboutme', '关于我', 'am-icon-user', 'Y', '7');

DROP TABLE IF EXISTS `sys_config`;
CREATE TABLE `sys_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `config_name` varchar(25),
  `config_key` varchar(25),
...
INSERT INTO `myblog`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `active`, `seq`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES ('1', 'SystemName', '001', '码农物语', 'System', 'Y', NULL, 'admin', '2020-11-04 12:20:20', 'admin', NULL);
INSERT INTO `myblog`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `active`, `seq`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES ('2', 'WeChat', '002', 'Hz770376343', 'System', 'Y', NULL, 'admin', '2020-11-04 12:21:26', 'admin', NULL);
INSERT INTO `myblog`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `active`, `seq`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES ('3', 'QQ', '003', '770376343', 'System', 'Y', NULL, 'admin', '2020-11-04 12:21:49', 'admin', NULL);
INSERT INTO `myblog`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `active`, `seq`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES ('4', 'Author', '004', 'LinAllen', 'System', 'Y', NULL, 'admin', '2020-11-04 12:27:23', 'admin', NULL);
INSERT INTO `myblog`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `active`, `seq`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES ('5', 'Introduction', '005', '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。愿你编码半生，归来仍是少年', 'System', 'Y', NULL, 'admin', '2020-11-04 12:29:00', 'admin', NULL);
...
INSERT INTO `myblog`.`broadcast`(`id`, `seq`, `value`, `active`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (16, '1', '愿你有前进一寸的勇气，亦有后退一尺的从容。', 'Y', 'admin', '2020-11-07 21:13:44', 'admin', NULL);
INSERT INTO `myblog`.`broadcast`(`id`, `seq`, `value`, `active`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (17, '2', '告诉自己，明天，肯定会更好。', 'Y', 'admin', '2020-11-07 21:14:04', 'admin', NULL);
INSERT INTO `myblog`.`broadcast`(`id`, `seq`, `value`, `active`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (18, '3', '有时候挺讨厌自己的，不会说话，太过善良，还没什么心眼。', 'Y', 'admin', '2020-11-07 21:14:21', 'admin', NULL);
INSERT INTO `myblog`.`broadcast`(`id`, `seq`, `value`, `active`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (19, '4', '愿你编码半生，归来仍少年', 'Y', 'admin', '2020-11-07 21:14:48', 'admin', NULL);
